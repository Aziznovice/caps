			...
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-heading">
					<h3 class="panel-title">Add The School Year</h3>
				  </div>
				  <div class="panel-body">
					...
					<form method="post" id="postForm">							
						...
						<div class="form-group">
							...
							<p class="text-muted">Please enter the School Year <strong></strong></p>
							<input type="text" class="form-control" id="categoryName" name="categoryName"  placeholder="e.g., 2023" oninput="this.value = this.value.replace(/[^0-9-]/g, '')" >							
						</div>				
